    ...
    <div className="tekster">
      ...
      <Heading as ="h2">Essays</Heading>
        <div className="textsWrap">
          <article>
            <LightBox src={EuropalterImg} alt="En blog fra Italien" linkText="Se hele bloggen" href="http://www.bing.com">
              <img src={EuropalterImg} className="thumb" alt="wih" /></LightBox>
            <StyledCard>
          ...
          <StyledCard>
            ...
            <LightBox src={BachelorImg} alt="Min bachelor" linkText="Læs hele bacheloren her" href="http://www.bing.com">
              <img src={BachelorImg} className="thumb" alt="wih" /></LightBox>
          </article>
        </div>
      </section>
      ...
      <section id="akademia">
        ...
        <div className="textsWrap">
          <article>
            <LightBox src={SpecialeImg} alt="Mit speciale" linkText="Læs hele specialet her" href="http://www.bing.com">
              <img src={SpecialeImg} className="thumb" alt="wih" /></LightBox>
            <StyledCard>
